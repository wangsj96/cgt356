...
<table style="border=0px; width:500px; padding:0px; margin:0px auto; border-spacing:0px;" title="listing of employees">
	...
	<tbody>
        ...
        ?>
        <tr>
        	<td style="border-right:1px solid black"><a href="updateUser.php?id=<?php echo trim($row["UserID"]) ?>">edit</a> | <a href="deleteUser.php?id=<?php echo trim($row["UserID"]) ?>">delete</a></td>
