...
<head>
	...
	<style type="text/css">
		...
		fieldset{ padding:5px; border:1px solid #ccc; width:600px; margin:10px;}
		legend{ color:#000099; margin:0 10px 10px 0; padding:0 5px; font-size:11pt; font-weight:bold; }
		label span{ color:#ff0000; }
		fieldset#info {margin:30px auto 10px auto; width:570px;  height:200px;}
		fieldset#submit {margin:0 auto; width:570px; text-align:center;}
        ...
        <ul>
            <li> <label title="category" for="category">Category <span>*</span></label>
	            <select name="category" id="category">
					...
					?>
                    		<option value="<?php echo(trim($row["typeID"]))?>"><?php echo(trim($row["typeName"]))?></option>
                    <?php
						}
					?>
				</select>
            </li>
            <li> <label title="userfile" for="userfile">File: <span>*</span></label> <input type="file" name="userfile" id="userfile" size="20" /></li>
