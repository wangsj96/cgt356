...
<body>
    ...
    <?php 
		...
		?>		
			...
			?>	     
                    <div class="photo">
                    <a <?php echo("href='upload/".trim($row["typeID"]).$count).".jpg'"?> data-lightbox="<?php echo(trim($row["typeID"]))?>" data-title="">
                        <img <?php echo("src='mid/mid_".trim($row["typeID"]).$count).".jpg'"?> attr=''/>
                    </a>
                    <br />
                	<a id="link" href="doDownload.php?file=<?php echo(trim($row["typeID"]).$count).".jpg"?>">Click to download this picture</a>
                    <br />
                    </div>
				<?php	
				}
