...
<head>
	<title>Lab 08 - Multiple Upload</title>
	...
	<style type="text/css">
		...
		fieldset#submit {position:absolute; top:360px; left:20px; width:460px; text-align:center; }
		fieldset input#SubmitBtn{ background:#E5E5E5; color:#000099; border:1px solid #ccc; padding:5px; width:150px;}
		div#errorMsg {color:#ff0000; font-weight:bold; font-size:12pt; position:absolute; top:450px; left:25px;}
		div#newLogin {color:#0000ff; font-size:12pt; position:absolute; top:350px; left:25px;}
	</style>
</head>

<body>
<h1 style="font-size:14pt; text-indent:360px;">Lab 08 - Multiple Upload</h1>
...
<form id="form0" method="post" action="doUpload2.php" enctype="multipart/form-data"> 
    <fieldset id="info">
        ...
        <ul>
            ...
            <li> <label title="userfile" for="userfile1">File: <span>*</span></label> <input type="file" name="userfile1" id="userfile1" size="25" /></li>
            <li> <label title="userfile" for="userfile2">File: <span>*</span></label> <input type="file" name="userfile2" id="userfile2" size="25" /></li>
            <li> <label title="userfile" for="userfile3">File: <span>*</span></label> <input type="file" name="userfile3" id="userfile3" size="25" /></li>
            <li> <label title="userfile" for="userfile4">File: <span>*</span></label> <input type="file" name="userfile4" id="userfile4" size="25" /></li>
            <li> <label title="userfile" for="userfile5">File: <span>*</span></label> <input type="file" name="userfile5" id="userfile5" size="25" /></li>
